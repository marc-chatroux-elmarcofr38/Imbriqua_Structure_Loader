...
pub fn open_loader(file_env: FileEnv) -> loading_tracker_basics::LoadingTracker {
    loading_tracker_basics::LoadingTracker::new(file_env)
}
...
mod loading_tracker_basics {
    ...
    pub struct LoadingTracker {
        ...
        pub loaded_package: HashMap<String, loading_package::LoadingPackage>,
        ...
        pub fn check_circular_loading(&self, label: &String) -> bool {
            ...
            // 2nd loading of A -> A already reserved and Empty
                ...
                *self
                    ...
                    .1
                    .get_state()
                    == loading_package::LoadingState::Empty
            }
        }
...
mod loading_tracker_algorythme {
    // Package section
    use super::*;

    impl loading_tracker_basics::LoadingTracker {
        ...
        pub fn prepare(&mut self, main_file: &str, package_id: &str, parent_label: &str) {
            // Make empty package
            let package = loading_package::LoadingPackage::new(
        ...
        fn make_mod_file_from_package(&mut self) {
            ...
            for (label, package) in &self.loaded_package {
                ...
                let _ = element_obj.write_to(&mut buf);
