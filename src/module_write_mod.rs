...
#![warn(missing_docs)]
#![doc = include_str!("../doc/module_write_mod.md")]
...
#[derive(Clone, Debug)]
/// Pack of all information necessary
...
// fn build_class_classification() -> HashMap<String, ClassClassification> {
//     //
//     let result: HashMap<&str, LoadingPreCalculation> = HashMap::new();

//     // Logs
//     debug!("Generating class classification : START");
...
//     }
//     // Logs
//     info!("Generating class classification : Finished");
...
impl WritingStruct for CMOFAssociation {
    fn wrt_struct_level(&self, writer: &mut File) {
        let _ = writeln!(writer);
...
impl WritingStruct for CMOFClass {
    fn wrt_struct_level(&self, writer: &mut File) {
        // Doc
        self.wrt_doc(writer);
        // Start of Struct
...
impl WritingStruct for CMOFDataType {
    fn wrt_struct_level(&self, writer: &mut File) {
        // Doc
        let _ = writeln!(writer);
        let _ = writeln!(
...
impl WritingStruct for CMOFEnumeration {
    fn wrt_struct_level(&self, writer: &mut File) {
        // Doc
        let _ = writeln!(writer);
        let _ = writeln!(
...
impl WritingStruct for CMOFEnumerationLiteral {
    fn wrt_struct_level(&self, writer: &mut File) {
        let _ = writeln!(
            writer,
            "    /// '{}' from (id : '{}', name : '{}')",
...
impl WritingStruct for CMOFPackage {
    fn wrt_struct_level(&self, writer: &mut File) {
...
impl WritingStruct for CMOFPrimitiveType {
    fn wrt_struct_level(&self, writer: &mut File) {
        // Doc
        let _ = writeln!(writer);
        let _ = writeln!(
...
impl WritingStruct for CMOFProperty {
    fn wrt_struct_level(&self, writer: &mut File) {
        // type
...
impl WritingStruct for EnumOwnedMember {
    fn wrt_struct_level(&self, writer: &mut File) {
        match self {
...
impl WritingStruct for EnumOwnedAttribute {
    fn wrt_struct_level(&self, writer: &mut File) {
        match self {
            EnumOwnedAttribute::Property(content) => {
                content.wrt_struct_level(writer);
...
impl WritingStruct for EnumOwnedEnd {
    fn wrt_struct_level(&self, writer: &mut File) {
        match self {
...
impl WritingStruct for EnumOwnedLiteral {
    fn wrt_struct_level(&self, writer: &mut File) {
        match self {
...
impl WritingStruct for EnumPackageImport {
    fn wrt_struct_level(&self, writer: &mut File) {}
}

impl WritingStruct for EnumRedefinedProperty {
    fn wrt_struct_level(&self, writer: &mut File) {
        match self {
...
impl WritingStruct for EnumSubsettedProperty {
    fn wrt_struct_level(&self, writer: &mut File) {
        match self {
...
impl WritingStruct for RedefinedProperty {
    fn wrt_struct_level(&self, writer: &mut File) {
        let _ = writeln!(
            writer,
...
impl WritingStruct for SubsettedProperty {
    fn wrt_struct_level(&self, writer: &mut File) {
        let _ = writeln!(
            writer,
...
impl EnumType {
    pub fn get_type_name(&self) -> String {
        match self {
            EnumType::ClassLink(content) => String::from("i8"),
            EnumType::DataTypeLink(content) => String::from("i8"),
...
impl WritingStruct for EnumType {
    fn wrt_struct_level(&self, writer: &mut File) {
        match self {
